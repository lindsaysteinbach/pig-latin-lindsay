...
class PigHandler(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        pl_result = pig_latinize_word(self.request.get("user_word"))

        my_pig_variables = {"pig_latin_word" : pl_result, "city" : "Chicago"}
        pig_template=my_env.get_template('templates/pig.html')
        self.response.write(pig_template.render(my_pig_variables))
